...
public protocol Verification {
    ...
    */
    func initiate(_ completion: (Bool, NSError?) -> Void);
    ...
    - parameter completion: Closure that will be invoked upon completion.
    */
    func verify(_ code: String, completion: (Bool, NSError?) -> Void);
...
*/
public func SMSVerification(applicationKey: String, phoneNumber: String) -> Verification {
    let objcVerification = SINVerification.smsVerification(withApplicationKey: applicationKey, phoneNumber: phoneNumber);
...
/**
 ...
 - returns: A new SMS Verification object.
 */
public func SMSVerification(applicationKey: String, phoneNumber: String, custom: String) -> Verification {
...
*/
public func CalloutVerification(applicationKey: String, phoneNumber: String) -> Verification {
...
/**
 ...
 - returns: A new Callout Verification object.
 */
public func CalloutVerification(applicationKey: String, phoneNumber: String, custom:String) -> Verification {
...
*/
public enum PhoneNumberParseError: ErrorProtocol {
...
public final class TextFieldPhoneNumberFormatter {
    ...
    */
    public func exampleNumber(format:PhoneNumberFormat) -> String? {
...
internal class VerificationWrapper: Verification {
    ...
    func initiate(_ completion: (Bool, NSError?) -> Void) {
        self.objcVerification.initiate(completionHandler: { (success: Bool, error: NSError?) -> Void in
